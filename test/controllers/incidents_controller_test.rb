...
class IncidentsControllerTest < ActionController::TestCase
  ...
  test "should create incident" do
    assert_difference('Incident.count') do
      post :create, incident: { category_id: @incident.category_id, description: @incident.description, name: @incident.name, priority_id: @incident.priority_id, status: @incident.status }
    end
  ...
  test "should update incident" do
    patch :update, id: @incident, incident: { category_id: @incident.category_id, description: @incident.description, name: @incident.name, priority_id: @incident.priority_id, status: @incident.status }
    assert_redirected_to incident_path(assigns(:incident))
  end
